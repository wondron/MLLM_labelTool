...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.client = SSHClient('config/ssh_config.ini')
        self.client.connect_linux()
        image_list = self.client.get_image_names("/data/wangzhuo/00-dataset/57-99test/菠萝/")
        self.collapsible_list.update_list(image_list)
